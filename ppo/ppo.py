...
def ppo(env,
    ...
    # logger.load_pytorch_model(ac)

    path = '../../logs/ppo-kuka-reach/ppo-kuka-reach_s0/pyt_save/model.pt'
    if osp.exists(path):
        try:
  ...
  (v): MLPCritic(
    ...
    # Set up model saving
    logger.setup_pytorch_saver(ac.state_dict())
    ...
    for epoch in range(epochs):
        ...
        if (epoch % save_freq == 0) or (epoch == epochs - 1):
            ...
            torch.save(ac.state_dict(),f'../../logs/ppo-kuka-reach/ppo-kuka-reach_s0/pyt_save/model.pt')
